    ...
    ui(new Ui::Dialog)
{
    ...
    minMsg->setText("MessageRelay will continue to run in the background. Right click on the tray icon and click on quit to close MessageRelay");
...
void Dialog::setPortText(QString  port)
{
    ui->lineEdit_2->setText(port);
}

void Dialog::setIPText(QString ip)
{
...
void Dialog::disconnectedServer()
{
    ui->pushButton->setText("Connect");
}

void Dialog::connectedServer()
{
